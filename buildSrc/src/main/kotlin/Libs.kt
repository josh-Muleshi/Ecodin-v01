...
object Libs {
    ...
    const val firebase_crashlytics_plugin = "com.google.firebase:firebase-crashlytics-gradle:2.5.1"
    ...
    const val work_runtime = "androidx.work:work-runtime-ktx:_"
    const val preference_ktx = "androidx.preference:preference-ktx:_"
    const val core_splashscreen = "androidx.core:core-splashscreen:1.0.0-alpha01"
    ...
    const val compose_constraint_layout = "androidx.constraintlayout:constraintlayout-compose:_"
    ...
    const val coil_core = "io.coil-kt:coil:2.0.0-rc03"
    ...
    const val accompanist_webview = "$accompanist:accompanist-webview:0.24.2-alpha"
    ...
    const val firebase_app_distribution_plugin =
    ...
    const val ktor_core = "io.ktor:ktor-client-core:_"
    const val ktor_android = "io.ktor:ktor-client-android:_"
    ...
    const val smart_location = "io.nlopez.smartlocation:library:_"
    ...
    const val compose_forms = "com.keygenqt.forms:compose-forms:_"
    const val leakcanary_android = "com.squareup.leakcanary:leakcanary-android:2.7"

    // Todo: Put this in the version.properties file
    const val compose_destinations_core = "io.github.raamcosta.compose-destinations:core:_"
    const val compose_destinations_ksp = "io.github.raamcosta.compose-destinations:ksp:_"
    ...
    const val orbit_mvi_viewmodel = "org.orbit-mvi:orbit-viewmodel:4.1.3"
    const val orbit_mvi_core = "org.orbit-mvi:orbit-core:4.1.3"
    const val orbit_mvi_test = "org.orbit-mvi:orbit-test:4.1.3"

    const val peko_permission = "com.markodevcic:peko:2.1.4"

    const val advanced_webview = "com.github.delight-im:Android-AdvancedWebView:v3.2.1"

    const val detekt = "io.gitlab.arturbosch.detekt:detekt-formatting:_"

    const val facebook_core = "com.facebook.android:facebook-core:_"
    const val facebook_login = "com.facebook.android:facebook-login:_"
    const val facebook_share = "com.facebook.android:facebook-share:_"
    const val facebook_messenger = "com.facebook.android:facebook-messenger:_"
    const val facebook_app_links = "com.facebook.android:facebook-applinks:_"
    const val facebook_android_sdk = "com.facebook.android:facebook-android-sdk:_"

    const val kalendar = "com.himanshoe:kalendar:_"
